 ...
 * 
 * Este projeto foi estruturado para ser seu guia completo.
 * No Módulo 1 (Fundamentos), aprenderemos a base sólida de um programador senior.
 */
public class Main {
    public static void main(String[] args) {
        System.out.println("=== CURSO ETEC: DO ZERO AO SENIOR (JAVA) ===");
        System.out.println("Descomente a aula que deseja executar abaixo:\n");

        // ======== MÓDULO 1: Fundamentos & Lógica Senior ========
        Aula01_Ecossistema.executar();
